...
coordToClipboard.addEventListener("click", copyCoord);
let isButtonActive = true;

function copyCoord() {
    if (isButtonActive) {
        isButtonActive = false;
        var toCopy = document.querySelector("#coordonnes").innerText;
        navigator.clipboard.writeText(toCopy);
        coordToClipboard.style.transition = "none";
        coordToClipboard.style.backgroundColor = "transparent";
        coordToClipboard.style.color = "#6286E1";
        coordToClipboard.innerText = "Copié !";
        coordToClipboard.style.cursor = "default";
        setTimeout(() => {
            coordToClipboard.style.backgroundColor = null;
            coordToClipboard.style.color = null;
            coordToClipboard.innerText = "Copier dans le presse-papier";
            coordToClipboard.style.cursor = null;
            isButtonActive = true;
            coordToClipboard.style.transition = "all 0.2s";
        }, 3000)
    }
}